...
void __attribute__((weak, alias("PendSVExceptionHandler")))     PendSV_Handler(void);
void __attribute__((weak, alias("SysTickExceptionHandler")))    SysTick_Handler(void);
